# 1. in browser download and name the file ffhq-dataset-v2.json  from: https://drive.google.com/file/d/16N0RV4fHI6joBuKbQAoG34V_cQk7vxSA/view
# also download LICENSE.txt, download_ffhq.py from https://github.com/NVlabs/ffhq-dataset/
# 2. drag ffhq-dataset-v2.json, LICENSE.txt, download_ffhq.py to the data folder
# 3. in terminal run  python download_ffhq.py -i
...
json_spec = dict(
    file_url='https://drive.google.com/uc?export=download&id=16N0RV4fHI6joBuKbQAoG34V_cQk7vxSA', 
    file_path='ffhq-dataset-v2.json', file_size=267793842, file_md5='425ae20f06a4da1d4dc0f46d40ba5fd6')
