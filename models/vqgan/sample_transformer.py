...
args.checkpoint_path = r"/media/userdisk1/code/VQGAN-pytorch/checkpoints/vqgan_epoch_50.pt"
n = 100
transformer = VQGANTransformer(args).to("cuda")
transformer.load_state_dict(torch.load(os.path.join("/media/userdisk1/code/VQGAN-pytorch/checkpoints", "transformer_57.pt")))
...
for i in tqdm(range(n)):
    ...
    vutils.save_image(sampled_imgs.add(1).mul(0.5), os.path.join("results", "transformer", f"transformer_{i}.jpg"), nrow=4)
